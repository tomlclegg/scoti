...
colnames(params)[1] <- "Simulation component"
...
## Spatial overlap extension

We extended the original `{scoti}` framework to represent a situation where there is spatial variation in the probability of a bycatch event occurring. 
