...
We have a fishing year that make sense for the fishery, trying to run a full simulation...The following code is grabbed directly from the repository as is
