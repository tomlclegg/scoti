...
We built a framework for incorporating spatial and temporal hot spots, as PET species can have strong spatiotemporal patterns in density and representative monitoring requires characterizing this variation. This framework requires further testing and parameter tuning before it should be used, but we provide some recommendations here as to how simulations and existing monitoring data can be used to provide scientific advice.
