...
```{r echo=FALSE,fig.cap='Increasing coverage in a reference fleet with different vessel effects. The vessel effect that generates a similar CV of BPUE to the one estimated with a GLMM from reference fleet data.', fig.id='vessel-effect', fig.cap.style= "Figure Caption"}
