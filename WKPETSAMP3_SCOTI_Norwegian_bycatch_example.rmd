...
```{r echo=FALSE,fig.cap='CV(BPUE) estimated from a simulated observer program with different refusal rates (colored lines) compare to CV(BPUE) estimated for the reference fleet (horizontal dotted line).', fig.id='ref-obs', fig.cap.style= "Figure Caption"}
